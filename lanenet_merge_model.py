...
class LaneNet(cnn_basenet.CNNBaseModel):
    ...
    def compute_loss(self, input_tensor, binary_label, instance_label, name):
        """
        Calculate the LaneNet model loss function
        :param input_tensor:
        :param binary_label:
        ...
        with tf.variable_scope(name):
            ...
            # Calculate the binary segmentation loss function
            ...
            # Calculate discriminative loss loss function
...
if __name__ == '__main__':
    ...
    input_tensor = tf.compat.v1.placeholder(dtype=tf.float32, shape=[1, 256, 512, 3], name='input')
    binary_label = tf.compat.v1.placeholder(dtype=tf.int64, shape=[1, 256, 512, 1], name='label')
    instance_label = tf.compat.v1.placeholder(dtype=tf.float32, shape=[1, 256, 512, 1], name='label')
